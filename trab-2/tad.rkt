...
(struct ambiente (nome descricao objetos enigmas saida estado) #:transparent)
...
;;   saida         : ambiente | Boolean - direções possíveis para outros ambientes. Caso não haja saída disponível, representado por #f.
